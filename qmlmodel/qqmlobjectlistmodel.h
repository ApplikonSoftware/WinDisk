...
public slots:
    ...
    virtual QObject* create(void) const = 0;
...
public:
    ...
    QObject* create(void) const
    {
        return static_cast<QObject*>(new ItemType);
    }
